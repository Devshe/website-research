...
import diagramImage from "./assets/architecture.png";
...
import goUp from "./assets/gopherUp.jfif";
import mongoDb from "./assets/mongoDb.jfif";
import go from "./assets/goLanguage.png";
      ...
      <section id="domain" className="section domain">
        ...
        <div className="domain-subsection" id="methodology">
          ...
          <div className="methodology-container">
            ...
            <div className="methodology-left">
              ...
              />
              <p className="figure-caption">Figure 2. System Architecture</p>
            </div>
            {/* Right Section: Blue Boxes */}
            <div className="methodology-right">
              <div className="blue-box">
                <p>
                  Requirement Analysis: Identifies critical gaps in existing
                  Go-based ODMs, focusing on performance, scalability, and
                  developer experience.
                </p>
              </div>
              <div className="blue-box">
                <p>
                  System Design and Architecture: Organized into four
                  layers—Core Layer, Query Builder Layer, Plugin Layer, and
                  Validation and Concurrency Layer.
                </p>
              </div>
              <div className="blue-box">
                <p>
                  Core Component Development: Iterative development of key
                  components such as the query builder, plugin system,
                  validation system, and concurrency management.
                </p>
              </div>
              <div className="blue-box">
                <p>
                  Security and Performance: Focuses on plugin isolation,
                  caching, asynchronous operations, and transaction management
                  to ensure efficiency, performance, and security.
                </p>
              </div>
              <div className="blue-box">
                <p>
                  Testing and Implementation: Involves benchmarking, integration
                  testing, and user feedback to validate the system's
                  performance and ensure it is scalable and ready for release.
                </p>
              </div>
              <div className="blue-box">
                <p>
                  The final product was released as a stable, open-source
                  solution, aimed at enhancing the Go ecosystem for developers
                  working with MongoDB.
                </p>
              </div>
              <img src={goUp} alt="Go Gopher" className="gopher-image" />
            </div>
          </div>
        </div>
        <div className="domain-subsection" id="technologies-used">
          ...
          <div className="technologies-container">
            {/* Left Section with go.jpg */}
            <div className="technologies-left">
              <img src={go} alt="Go Logo" className="tech-image" />
            </div>
            {/* Right Section with mongo.jpg */}
            <div className="technologies-right">
              <img src={mongoDb} alt="MongoDB Logo" className="tech-image" />
            </div>
          </div>
        </div>
      </section>
